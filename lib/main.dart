...
import 'package:sqflite_petercoding/model/user.dart';
import 'package:sqflite_petercoding/services/database_handler.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'SQLite Tutorial PeterCoding'),
    );
  }
}
